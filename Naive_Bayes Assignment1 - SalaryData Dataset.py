# -*- coding: utf-8 -*-
"""
Created on Thu Feb 22 21:24:33 2024
...
needs of your employees,so that they feel valued and supported. 
Organic business objectives are goals that incorporate all aspects of the business: 
its development, survival, progress and outlook.
Q.Are there any constraints?
information associated with each job post as text and then they represent 
each sample as a vector of word/keyword frequencies.
As a consequence, these vectors are often characterized by
a very high number of dimensions (in the order of thousands). 
Therefore, it is necessary to collect huge amounts of job posts 
to be able to train a classifier or a regression model effectively.
...
salary_train=pd.read_csv("C:\Data Set\SalaryData_Train.csv")
salary_test=pd.read_csv("C:\Data Set\SalaryData_Test.csv")
...
#let us check the wrong classified actual is grater
#than 50 and predicted is less than 50 is 469
#actual salary prediction less than 50 but predicted is
#'greater than 50' is 2920 ,this is not accepted
...
#let us check the wrong classified actual is 'grater than 50'
#and predicted is 'less than 50' is 936
#actual salary prediction less than 50 but predicted is 'greater than
# 50' is 5913 ,this is not accepted
...
###let us check the wrong classified actual is 'grater than 50'
# and predicted is 'less than 50 is 469
#actual salary prediction less than 50 but predicted is 'greater than 50'
# is 2920 ,this is not accepted
#Let us now evaluate on train data
...
#let us check the wrong classified actual is 'grater than 50' 
#and predicted is 'less than 50' is 936
#actual salary prediction less than 50 but predicted is 'greater
#than 50' is 5913 ,this is not accepted
