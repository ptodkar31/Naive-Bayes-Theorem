# -*- coding: utf-8 -*-
"""
Created on Thu Feb 22 21:24:59 2024
...
classify which of the users of the social network are going to purchase this luxury SUV.
1 implies that there was a purchase and 0 implies there wasn’t a purchase.

Business Problem:
Q.What is the business objective?
This will help you bring those audiences to your website who are interested in cars. 
And, there will be many of those who are planning to buy a car in the near future.

Communicating with your target audience over social media 
...
benefits for your business Additional resources may be needed to manage your 
online presence Social media is immediate and needs daily monitoring
If you don't actively manage your social media presence, you may not see any 
real benefits There is a risk of unwanted or inappropriate behavior on your
site including bullying and harassment Greater exposure online has the
potential to attract risks. Risks can include negative feedback information,
leaks, or hacking
...
car=pd.read_csv("C:/Data Set/NB_Car_Ad.csv")
