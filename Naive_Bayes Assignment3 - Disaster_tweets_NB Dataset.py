# -*- coding: utf-8 -*-
"""
Created on Thu Feb 22 21:24:16 2024
...
Business Problem:-
Though Social media has become almost an inevitable part of our society now, 
we can’t always depend on it. 
The spreading of misinformation in social media is not new. 
Every day we read bunches of things online on 
...
disagreement related to detecting fake news: 
    (1) disagreement regarding what content should be subject to moderation 
and (2) disagreement regarding whether that content is categorized accurately.
...
tweet=pd.read_csv("C:\Data Set\Disaster_tweets_NB.csv")
